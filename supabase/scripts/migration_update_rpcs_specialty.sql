-- Migration to update RPCs to handle specialty_id

-- 1. Update crear_requerimiento_completo
...
BEGIN
    ...
    INSERT INTO requerimientos (
        ...
        (p_cabecera->>'specialty_id')::UUID, -- Added value
...
-- 2. Update actualizar_requerimiento_completo
...
BEGIN
    ...
    SET
        ...
        specialty_id = (p_cabecera->>'specialty_id')::UUID, -- Added update
